...
function buildDelegatedExpandQueryTask(params: {
  ...
  return [
    ...
    "- If a requested detail is not directly retrievable from the evidence you already gathered, say \"not directly retrievable from retrieved evidence\" and finish.",
    "- Do not keep searching for an exact count / quote / wording once describe + targeted grep and one bounded expand attempt stop yielding new evidence.",
    "- Prefer a partial but evidence-backed JSON answer over continued search that risks timeout.",
